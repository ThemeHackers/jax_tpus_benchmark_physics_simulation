...
parser.add_argument("-m", "--steps", type=int, default=2500)
parser.add_argument("-mxs", "--matrix_size", type=int, default=4096)
parser.add_argument("-md", "--matrix_depth", type=int, default=6)
parser.add_argument("-c", "--conv_size", type=int, default=64)
